...
```
in this figure 5 we can see how the diffrent samples are spread according to there cancer stages.

\newpage
<!-- (Discussion and Conclusion) -->
# Discussion and Conclusion

in the results section we can see from the figures 1 and two that although the data set was supplied with the label as high quality there are still proteis in the data with
...
all this wasnt something to be expecting of high quality data. also in figure 5 it is clearlyt visible that the catagorisation of the tumor stage there are allot of T2 stages in the samples than any other.
